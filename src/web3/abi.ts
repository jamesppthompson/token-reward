const ABI = [
  {
    inputs: [
      { internalType: "uint256", name: "_snipeBlockAmt", type: "uint256" },
      { internalType: "uint256", name: "_gasPriceLimit", type: "uint256" },
      { internalType: "address payable", name: "FeeAddress", type: "address" },
      { internalType: "address payable", name: "FeeAddress2", type: "address" },
    ],
  ...
  },
  {
    anonymous: false,
    inputs: [
      { indexed: false, internalType: "bool", name: "_cooldown", type: "bool" },
    ],
  ...
  {
    inputs: [{ internalType: "uint256", name: "teamFee", type: "uint256" }],
    name: "setBuyFee",
    outputs: [],
    stateMutability: "nonpayable",
    type: "function",
  ...
  {
    inputs: [
      { internalType: "address payable", name: "newWallet", type: "address" },
    ],
    name: "setGTFWallet",
    outputs: [],
    stateMutability: "nonpayable",
  ...
  },
  {
    inputs: [
      ...
      { internalType: "bool", name: "antiGas", type: "bool" },
      { internalType: "bool", name: "antiBlock", type: "bool" },
    ],
